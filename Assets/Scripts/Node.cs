...
public class Node : MonoBehaviour
{
    ...
    private Vector3 _rangeOryginalSize;
    private void Start()
    {
        _rangeSize = attackRangeSprite.GetComponent<SpriteRenderer>().bounds.size.y;
        _rangeOryginalSize = attackRangeSprite.transform.localScale;
    }
    ...
    private void ShowTurretInfo()
    {
        ...
        attackRangeSprite.transform.localScale = _rangeOryginalSize * Turret.AttackRange / (_rangeSize / 2);
    }
}
